...
<body>
        ...
        <ul class="navbar-nav ms-auto d-flex gap-4">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="login-builder.php">Login</a>
              </li>
            </ul>
          </li>
        </ul>
      ...
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3">
          <div class="d-flex flex-row flex-lg-column">
            <img src="https://png.pngtree.com/png-clipart/20190118/ourlarge/pngtree-cartoon-hand-painted-character-hand-account-png-image_459844.jpg" class="col-4 rounded-4" />
          </div>
          <div class="d-flex flex-column col-8 ms-3 ms-lg-0 detail mt-3 mt-md-0" data-aos="fade-right" data-aos-duration="2000">
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="d-flex flex-row-reverse flex-md-row flex-lg-column">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyFjUzVEJHkdLO1ZIPZ6BXCuERpdnVyN14Zl6Vhw6aRex61e_E24IpvfGtRqaqYTfofDk&usqp=CAU" class="col-4 rounded-4" />
          </div>
          <div class="d-flex flex-column col-8 ms-3 ms-lg-0 detail mt-3 mt-md-0" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="300">
            ...
            <div class="d-flex gap-3 mt-2 mt-lg-4">
              <a href="#popup2" class="btn bg-orange text-orange rounded-pill px-4 shadow">Selengkapnya</a>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3">
          <div class="d-flex flex-row flex-lg-column">
            <img src="https://png.pngtree.com/png-clipart/20210224/ourlarge/pngtree-construction-worker-holding-a-brick-clipart-png-image_2945563.jpg" class="col-4 rounded-4" />
          </div>
          <div class="d-flex flex-column col-8 ms-3 ms-lg-0 detail mt-3 mt-md-0" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="500">
            ...
            <div class="d-flex gap-3 mt-2 mt-lg-4">
              <a href="#popup12" class="btn bg-orange text-orange rounded-pill px-4 shadow">Selengkapnya</a>
            </div>
          </div>
        </div>
  ...
  <div class="popup" id="popup">
    <div class="popup-content rounded-4">
      <div class="popup-img">
        <img src="https://png.pngtree.com/png-clipart/20190118/ourlarge/pngtree-cartoon-hand-painted-character-hand-account-png-image_459844.jpg" alt="" />
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyFjUzVEJHkdLO1ZIPZ6BXCuERpdnVyN14Zl6Vhw6aRex61e_E24IpvfGtRqaqYTfofDk&usqp=CAU" alt="" />
        <img src="https://png.pngtree.com/png-clipart/20210224/ourlarge/pngtree-construction-worker-holding-a-brick-clipart-png-image_2945563.jpg" alt="" />
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    <path fill="#ff8c00" fill-opacity="1" d="M0,64L20,96C40,128,80,192,120,213.3C160,235,200,213,240,186.7C280,160,320,128,360,122.7C400,117,440,139,480,154.7C520,171,560,181,600,202.7C640,224,680,256,720,229.3C760,203,800,117,840,101.3C880,85,920,139,960,170.7C1000,203,1040,213,1080,218.7C1120,224,1160,224,1200,197.3C1240,171,1280,117,1320,117.3C1360,117,1400,171,1420,197.3L1440,224L1440,320L1420,320C1400,320,1360,320,1320,320C1280,320,1240,320,1200,320C1160,320,1120,320,1080,320C1040,320,1000,320,960,320C920,320,880,320,840,320C800,320,760,320,720,320C680,320,640,320,600,320C560,320,520,320,480,320C440,320,400,320,360,320C320,320,280,320,240,320C200,320,160,320,120,320C80,320,40,320,20,320L0,320Z">
    </path>
  </svg>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
    <path fill="#ff8c00" fill-opacity="1" d="M0,224L20,234.7C40,245,80,267,120,277.3C160,288,200,288,240,250.7C280,213,320,139,360,101.3C400,64,440,64,480,101.3C520,139,560,213,600,229.3C640,245,680,203,720,181.3C760,160,800,160,840,170.7C880,181,920,203,960,229.3C1000,256,1040,288,1080,293.3C1120,299,1160,277,1200,266.7C1240,256,1280,256,1320,240C1360,224,1400,192,1420,176L1440,160L1440,0L1420,0C1400,0,1360,0,1320,0C1280,0,1240,0,1200,0C1160,0,1120,0,1080,0C1040,0,1000,0,960,0C920,0,880,0,840,0C800,0,760,0,720,0C680,0,640,0,600,0C560,0,520,0,480,0C440,0,400,0,360,0C320,0,280,0,240,0C200,0,160,0,120,0C80,0,40,0,20,0L0,0Z">
    </path>
  </svg>
  <!-- Tukang kami -->
  </section>
